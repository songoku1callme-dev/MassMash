...
export default function MarketplacePage() {
 ...
 {items.map((item: any) => (
 <div key={item.id} className="theme-card rounded-xl border border-[var(--border-color)] overflow-hidden hover:shadow-md transition-all">
 {/* Header */}
 ...
 {item.description && (
 <p className="text-sm theme-text-secondary mt-1 line-clamp-2">{item.description}</p>
 )}
 </div>
