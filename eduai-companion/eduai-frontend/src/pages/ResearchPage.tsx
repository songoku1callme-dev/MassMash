        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {results.map((r, idx) => (
                <div key={idx} className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-blue-300 transition-colors">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex-1">
                      <h3 className="font-medium text-gray-900 dark:text-white text-sm">{r.title}</h3>
                      <a
                        href={r.url}
                        target="_blank"
