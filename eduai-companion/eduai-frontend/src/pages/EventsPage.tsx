      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {selectedEvent && (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{selectedEvent.name}</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">{selectedEvent.description}</p>
            ...
            {/* Challenges */}
            <h3 className="font-medium text-gray-900 dark:text-white mb-3">Challenges</h3>
            {progress ? (
              <div className="space-y-3">
                {progress.challenges?.map((ch: any, idx: number) => (
                  <div key={idx} className="p-3 rounded-lg border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Lade Fortschritt...</p>
            )}
          </div>
        )}
      </div>
