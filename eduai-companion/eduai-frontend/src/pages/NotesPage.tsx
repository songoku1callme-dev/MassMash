...
export default function NotesPage() {
 ...
 className="w-full min-h-[400px] p-4 rounded-lg border border-[var(--border-color)] theme-card theme-text resize-y focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono text-sm"
 ...
 <CardContent>
 <pre className="whitespace-pre-wrap text-sm theme-text-secondary">{aiResult}</pre>
 </CardContent>
 </Card>
 )}
 </div>
 ...
 <p className="theme-text-secondary mt-1">Schreibe und verbessere deine Notizen mit KI</p>
 </div>
