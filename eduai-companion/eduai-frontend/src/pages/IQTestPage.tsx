    ...
    return (
      <div className="p-4 lg:p-6 max-w-4xl mx-auto space-y-6">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">IQ-Test</h1>
          ...
          {Object.entries(KATEGORIE_LABELS).map(([key, { label, icon, color }]) => (
            <Card key={key} className="text-center">
              <CardContent className="pt-4 pb-3">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">8 Fragen</p>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="pt-4 flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white text-sm">45 Minuten</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Zeitlimit für alle Fragen</p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-4 flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white text-sm">40 Fragen</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">8 pro Kategorie, kein Zurück</p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-4 flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white text-sm">IQ-Auswertung</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Normalverteilung + Kategorien</p>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="border-indigo-200 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-900/20">
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-indigo-900 dark:text-indigo-200">Dein letztes Ergebnis</p>
      ...
      <div className="p-4 lg:p-6 max-w-3xl mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{katInfo.label}</span>
          </div>
          <div className={`flex items-center gap-2 font-mono text-lg font-bold ${timeRemaining < 300 ? "text-red-500" : "text-gray-900 dark:text-white"}`}>
    ...
    return (
      <div className="p-4 lg:p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{result.klassifikation}</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">{result.vergleich}</p>
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">IQ-Bereich: {result.iq_range}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <Card>
            <CardContent className="pt-4 text-center">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">IQ-Wert</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-4 text-center">
              <p className="text-2xl font-bold text-indigo-500">{result.percentile}%</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">Perzentil</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-4 text-center">
          ...
          <Card>
            <CardContent className="pt-4 text-center">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Max. Punkte</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="relative h-24">
              ...
              <div className="absolute inset-0 flex items-end">
                {Array.from({ length: 40 }, (_, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`flex-1 rounded-t-sm ${isUserRange ? "bg-indigo-500" : "bg-gray-200 dark:bg-gray-700"}`}
                      style={{ height: `${height}%` }}
                    />
                  );
                })}
              ...
              >
                <div className="text-xs font-bold text-indigo-600 dark:text-indigo-400 bg-white dark:bg-gray-900 px-1 rounded">
                  Du: {result.iq}
                </div>
              </div>
            </div>
