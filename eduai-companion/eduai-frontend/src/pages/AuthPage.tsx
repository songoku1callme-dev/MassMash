...
const clerkAppearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButton:
      "!bg-[rgba(255,255,255,0.05)] !border !border-[rgba(255,255,255,0.1)] !text-white hover:!bg-[rgba(255,255,255,0.1)] !rounded-xl",
    socialButtonsBlockButtonText: "!text-white",
    formFieldInput:
      "!bg-[rgba(255,255,255,0.05)] !border-[rgba(255,255,255,0.1)] !text-white !rounded-xl placeholder:!text-slate-500",
    formFieldLabel: "!text-slate-300",
    formButtonPrimary:
      "!bg-gradient-to-r !from-indigo-500 !to-violet-500 hover:!from-indigo-600 hover:!to-violet-600 !rounded-xl !font-semibold !shadow-lg !shadow-indigo-500/25",
    ...
    otpCodeFieldInput: "!bg-[rgba(255,255,255,0.05)] !border-[rgba(255,255,255,0.1)] !text-white",
    alert: "!bg-[rgba(239,68,68,0.1)] !border-[rgba(239,68,68,0.2)] !text-red-400",
