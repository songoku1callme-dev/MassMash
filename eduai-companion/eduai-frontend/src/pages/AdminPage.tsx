  ...
  return (
    <div className="p-4 lg:p-6 max-w-6xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Verwalte User, Abos, Gutscheine und Statistiken</p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="max-h-48 overflow-auto space-y-1">
              {users.map((u) => (
                <div key={u.id}
                  className="flex items-center justify-between p-2 rounded bg-gray-50 dark:bg-gray-800 text-sm cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700"
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex gap-2">
              <select value={grantTier} onChange={(e) => setGrantTier(e.target.value)}
                className="flex h-10 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100">
        ...
        <Card>
          ...
          <CardContent>
            <div className="max-h-48 overflow-auto space-y-2">
              ...
              {coupons.map((c) => (
                <div key={c.id} className="flex items-center justify-between p-2 rounded bg-gray-50 dark:bg-gray-800 text-sm">
                  <div>
