      ...
      {joined && !submitted && tournament && (
        <>
          <div className="flex items-center justify-between p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
            ...
            <span className={`text-2xl font-mono font-bold ${timeLeft < 60 ? "text-red-600" : "text-yellow-700 dark:text-yellow-300"}`}>
              {formatTime(timeLeft)}
            </span>
          </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {rankings.map((r) => (
                <div key={r.rank} className="flex items-center justify-between p-2 rounded bg-gray-50 dark:bg-gray-800">
                  ...
                  <div className="text-sm text-gray-500">
                    <span className="font-bold text-gray-900 dark:text-white">{r.score}</span>
      ...
      {winners.length > 0 && (
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {winners.map((w) => (
                <div key={w.rank} className="flex items-center justify-between p-3 rounded-lg bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/10 dark:to-amber-900/10">
                  <div className="flex items-center gap-3">
